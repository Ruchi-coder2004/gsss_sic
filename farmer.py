...
He gets a yield of the following for tomatoes. 

30% of his tomato land gives him 10 tonne yield per acre.
...
cabage_sale = 24 * 14000 * land_segment
...
total_yeild = tomato_sale_30 + tomato_sale_70 + patoato_sale + sugarcane_sale + sunflower_sale + cabage_sale

print('Total yeild: ', total_yeild)

print('Sales realisation from chemical-free farming at the end of 11 months: ',total_yeild-sugarcane_sale)