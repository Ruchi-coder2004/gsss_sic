...
class EmployeeOperations:
    def connect_db(self):
        try:
            ...
            password='Ruchi@2004', database='ruchitha_db', port=3306)
    ...
    def create_row(self, employee : Employee):
        ...
        count = cursor.execute(query, (employee.name,employee.designation,employee.phone_number,employee.commission,employee.salary,employee.years_of_exp,employee.location))
        connection.commit()
        cursor.close()
